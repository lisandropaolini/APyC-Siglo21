...
int main(){
    ...
    while(num_jugadores<=0 || num_jugadores>3){
      printf("\n\n Bienvenido al juego de cartas de la siete y medio \n\n");
      printf("Introduzca el numero de jugadores (1-3), más la banca: \n");
      fflush(stdin);
          ...
          if(jugadores[i].se_ha_plantado==0){
             ...
             //Si no es la banca, juegan los jugadores, sacan carta o se plantan
              ...
              if(tecla=='c'){
                   ...
                   printf("Para El jugador %d, La carta sacada es %s \n",i,nombre_carta);
       ...
       if(fin_partida == 1){
         ...
         for(j=0;j<=num_jugadores;j++){
             if(jugadores[j].puntos==puntos_max){
                 cout << "\n El jugador "+to_string(j)+" es el ganador!!!!";
             ...
             if(tecla=='n'){
                 ...
                 for(j=0;j<=num_jugadores;j++){
                   ...
                   if(jugadores[j].partidas_ganadas == num_partidas_ganadas && j==0){
                       printf("\n La Banca gana!!!! con %d partidas ganadas \n",num_partidas_ganadas);
                   }else if(jugadores[j].partidas_ganadas == num_partidas_ganadas){
                       printf("\n El jugador %d es el ganador !!!! con %d partidas ganadas \n",j,num_partidas_ganadas);
                   }
                 }
